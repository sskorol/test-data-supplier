    ...
    public void ymlDataSupplierTestsShouldWork() {
        ...
        assertThat(listener.getSucceedMethodNames())
            ...
            .containsExactly(
                ...
                "addons={sonarcloud=Addon(organization=sskorol-github, token=Token" +
                "(secure=G0io5DQn6jsZS58Nk04xMP8b6RmdOSrR5LaFnfHTeVNDhy1KBVt5/pSQL7od9S0o9UreZSidZ9FXKSTWQxmkJJ" +
                "/RZIsw91DX2nWwRCqIL5XqRi+sKHjnToeJUmn5HuAYnAQ6NoSg5l9HryXEX6PG2n15hRBUjjpigOu+W4gL7JCpYlIQ" +
                "/FcvzaEnw0n4APGEoldTpfSUHbnbzWiTFFB9Cyy4ke/DwBiabKwTCAWwzXXeXRKIFYnDqITKapx0kNRlZyq" +
                "/nElHmd0q29Y4zuvd2YFB" +
                "))}, jdk=[openjdk11], script=[./gradlew clean test jacocoTestReport sonarqube], cache={directories=[$HOME/.m2/repository, $HOME/.sonar/cache, $HOME/.gradle, .gradle]}, notifications={email=Email(recipients=[serhii.s.korol@gmail.com])}))",
