...
public class DataSupplierTests extends TestNGRunner {
    ...
    public void ymlDataSupplierTestsShouldWork() {
        val listener = run(YamlDataSupplierTests.class);
